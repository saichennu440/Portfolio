        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <a href="#home" className="text-2xl font-bold">
              Sai<span className="text-blue-400">Chennu</span>
            </a>
            <p className="mt-2 text-gray-400 max-w-md">
              Software developer focused on creating beautiful and functional applications with clean code.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center md:items-end">
            ...
            <p className="text-gray-500 flex items-center">
              © {currentYear} Sai Chennu. Made with <Heart size={16} className="mx-1 text-red-500" /> All rights reserved.
            </p>
          </div>
        </div>
